...
class Parent extends PureComponent {
  ...
  changeGender = () => {
    this.setState((state) => ({ gender: state.gender === "男" ? "女" : "男" }));
  };
  ...
  render() {
    console.log("Parent");
    const { age, name, gender } = this.state;
    return (
      <div className="parent">
        ...
        <button onClick={this.changeGender}>该性别</button>
        {/* 传递了 gender 但是子组件没有使用，由于父组件修改数据，子组件也会重新渲染 */}
        <Child {...this.state} />
